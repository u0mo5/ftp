<?php
// +----------------------------------------------------------------------
// | Copyright (C) 2008-2015 BookFuns.Com
// +----------------------------------------------------------------------
// | Author: 狂飙的小蜗牛
	...
	<div class="col-sub">
		<ul id="main-menu">
			...
			<li id="help5">
				<span>
					<i class="icon"></i>
					<a href="javascript:void(0);" onclick="window.open('./editor.php');" rel="imageStyle">编辑器</a>
				</span>
			</li>
			<li id="help10">
				<span>
					<i class="icon"></i>
					<a href="javascript:void(0);" onclick="window.open('./filebox.php');" rel="imageStyle">文件管理</a>
				</span>
			</li>
			<li id="help11">
				<span>
					<i class="icon"></i>
					<a href="javascript:void(0);" onclick="window.open('http://app.bookfuns.com');" rel="imageStyle">应用商店</a>
				</span>
			</li>
			<li id="help9">
				<span>
					<i class="icon"></i>
					<a href="javascript:void(0);" onclick="window.open('./adminer.php');" rel="imageStyle">数据库</a>
				</span>
			</li>
		  	<li id="help6">
		  		<span>
...
<div id="footer">
	...
	CopyRight ©2011-2015 <a href="http://admin.BookFuns.Com/?webftp" target="_blank">BookFuns.Com</a> All Rights Reserved.
</div>
